...
namespace har
{
    internal class Program
    {
        ...
        {
            Allatkert allatkert = new("állatkert");
            allatkert.Feltoltes();
            ...
            while (true)
            {
                ...
                switch (key.Key)
                {
                    ...
                    case ConsoleKey.Enter: if (!inDialogue) { DrawDialogueBox(); } else { if (jelenlegiMutato == 2) { Verseny(); } else { inDialogue = false; DrawMap(map); } } break;
